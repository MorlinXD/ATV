    ...
    <div id="indicators-carousel" className="flex flex-col gap-4">
      <div className="relative overflow-hidden rounded-lg">
        {videoUrls.map((url, index) => (
          <div key={index} className={index === activeIndex ? 'block duration-700 ease-in-out aspect-w-16 aspect-h-9' : 'hidden duration-700 ease-in-out aspect-w-16 aspect-h-9'}>
            <YouTubeEmbed
              videoid={url}
      ...
      <div className='flex flex-row justify-center'>
        ...
        <button type="button" className="top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer" onClick={handlePrev}>
        ...
        <button type="button" className="top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer" onClick={handleNext}>
