      ...
      <div className='container mx-auto flex flex-col justify-center items-center'>
        <div className='flex flex-col items-center'>
          <Image
            ...
            height={120}
          />
          <h2 className='text-6xl mt-4 font-bold text-hcaneworange text-center'>¡Tenemos algo emocionante que contarte!</h2>
        </div>
        <p className='text-2xl mt-4 text-hcablack text-center'>
          ...
          <br />
          <br />
          Las actividades principales del proyecto “Alza Tu Voz” se enfocan en tres cosas: fortalecer conocimientos, participar y
        ...
        <p className='text-2xl mt-4 text-hcablack font-bold text-center mb-20'>¡Así que prepárense Quevedo y Riobamba! ¡Vamos a hacer historia entre todos y todas!</p>
      </div>
    </section>
