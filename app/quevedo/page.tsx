    ...
    <main className="flex min-h-screen flex-col items-center mt-16">
      ...
      <HeroQuevedo>
        <div className="container mx-auto flex flex-col justify-center items-center text-center">
          ...
          <p className='text-black mt-10 text-justify mx-10 lg:mx-72 xl:mx-80 text-xl mb-5 leading-10'>
            ...
            ¡Es súper fácil! Solo dale clic a este enlace y escribe <strong className='text-hcadarkblue'>'HOLA'</strong> para que puedas marcar la
      ...
      <section className=" container mx-auto flex flex-col justify-center items-center text-center mt-20">
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-6 p-2 lg:p-20'>
          <p className='text-black mt-10 text-justify mx-10 lg:mx-20'>
            Somos un grupo de jóvenes de diferentes partes de Quevedo que conocieron acerca del trabajo de LAB XXI, nos preocupa
