  ...
  return (
    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className='container mx-auto flex flex-col justify-center items-center'>
        ...
        <h2 className='text-6xl mt-4 font-bold text-hcanewblue text-center'>¡Conformamos el grupo núcleo en <strong className='text-hcaneworange'>Quevedo!</strong></h2>
        <p className='text-2xl mt-4 text-hcablack text-center'>
          ...
          <br />
          <br />
          Nos interesa aportar al desarrollo de Quevedo y que nuestro bienestar sea una prioridad. Por esto, nos unimos a este increíble
    ...
    <section className='container mx-auto flex flex-col justify-center items-center mt-20'>
      ...
      <p className='text-2xl mt-4 text-hcablack text-center'>
        Creamos mapas parlantes que cuentan cómo las y los adolescentes y jóvenes nos relacionamos con<br/> Quevedo y cómo nos gustaría que se transforme.
      </p>
      ...
      <div className='container mx-auto flex flex-col justify-center items-center'>
        <div className='flex flex-col items-center'>
          <Image
            ...
            height={75}
          />
          <h2 className='text-6xl mt-4 font-bold text-hcanewblue text-center'>Quevedo en Datos</h2>
        </div>
