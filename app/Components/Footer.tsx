    ...
    <div className="relative flex justify-center bg-cover bg-center lg:h-80 pt-20" style={{ backgroundImage: 'url("/images/art-footer.png")' }}>
      <div className="flex flex-col items-center justify-center p-4 space-y-4 lg:space-y-0">
        ...
        <div className="flex flex-col items-center md:flex-row space-y-2 md:space-y-0 md:space-x-8">
          <a href="#link1" className=" hover:underline">Política de privacidad</a>
          <a href="#link2" className=" hover:underline">Política de cookies</a>
          <a href="#link3" className=" hover:underline">¿Tienes dudas o sugerencias? ¡Escríbenos!</a>
        </div>
      </div>
    </div>
    <Image
