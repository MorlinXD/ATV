  ...
  return (
    <main className="flex min-h-screen flex-col items-center mt-16">
      ...
      <div className="flex flex-col justify-center items-center text-center my-16 lg:my-20 px-8">
        <h3 className='text-2xl text-black mt-16'>Healthy Cities for Adolescents (HCA) nos ha fichado como prioridad para su Fase II.</h3>
        <h3 className='text-2xl text-black mt-16'>¡Las estrellas del show, <span className='text-hcadarkblue'>Quevedo y Riobamba</span>!</h3>
